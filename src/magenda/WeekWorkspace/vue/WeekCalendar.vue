...
//import { CalendarWidget as DayTimeLogger} from '@/modules/timesheets/vue'
...
export default {
  components: {
    ...
    /*DayTimeLogger: defineAsyncComponent({
      loader: () => new Promise((res) => res(MAgenda.vueModules['timesheets'].CalendarWidget))
    })*/
    DayTimeLogger: MAgenda.vueModules['timesheets']?.CalendarWidget
